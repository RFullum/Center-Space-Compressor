...
PNGs embedded by the top-level `README.md`. Capture at 2× the editor's
native size (2560×1440) using `Cmd+Shift+4` then `Space` on macOS to grab
just the plugin window. Compress with `pngquant --quality=70-85 *.png`
before committing.
