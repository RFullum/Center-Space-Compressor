...
{
    // Host-driven bypass is intentionally outside the patch payload — loading
    // a patch should never override the user's current bypass state.
