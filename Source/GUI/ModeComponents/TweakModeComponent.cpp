...
void TweakModeComponent::SliderSetup(juce::Slider &slider, juce::LookAndFeel &lf)
{
...
void TweakModeComponent::LabelSetup(juce::Label &label, const juce::String &text)
{
...
void TweakModeComponent::ComboSetup(juce::ComboBox &box, const juce::StringArray &items)
{
